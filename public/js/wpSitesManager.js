document.addEventListener('DOMContentLoaded', () => {
    ...
    const aiPromptHeaderInput = document.getElementById('wp-ai-prompt-header');
    ...
    function resetForm() {
        ...
        if (aiPromptHeaderInput) aiPromptHeaderInput.value = '';
    ...
    function setEditMode(site) {
        ...
        if (aiPromptHeaderInput) aiPromptHeaderInput.value = site.aiPromptHeader || '';
